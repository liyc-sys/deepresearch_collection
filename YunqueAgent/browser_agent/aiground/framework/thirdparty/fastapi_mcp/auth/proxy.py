...
def setup_oauth_custom_metadata(
    ...
    metadata: Annotated[
        OAuthMetadataDict, Doc("The custom metadata specified in AuthConfig")
    ],
    include_in_schema: Annotated[
        bool, Doc("Whether to include the metadata endpoint in your OpenAPI docs")
    ] = False,
):
    """
...
def setup_oauth_authorize_proxy(
    ...
    path: Annotated[
        str, Doc("The path to mount the authorize endpoint at")
    ] = "/oauth/authorize",
    include_in_schema: Annotated[
        bool, Doc("Whether to include the authorize endpoint in your OpenAPI docs")
    ] = False,
):
    """
...
def setup_oauth_fake_dynamic_register_endpoint(
    ...
    client_secret: Annotated[
        str, Doc("The client secret of the pre-registered client")
    ],
    path: Annotated[
        str, Doc("The path to mount the register endpoint at")
    ] = "/oauth/register",
    include_in_schema: Annotated[
        bool, Doc("Whether to include the register endpoint in your OpenAPI docs")
    ] = False,
):
    """
    ...
    async def oauth_register_proxy(
        request: ClientRegistrationRequest,
    ) -> ClientRegistrationResponse:
        client_response = ClientRegistrationResponse(
            client_name=request.client_name
            or "MCP Server",  # Name doesn't really affect functionality
            client_id=client_id,
